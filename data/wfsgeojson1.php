<?php
	...
	$wfsUrl = file_get_contents("http://localhost:8080/geoserver/ACARA_IV/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=ACARA_IV%3AFAS_KESEHATAN_PT_SLEMAN_RSRUJUKAN_Proj&outputFormat=application%2Fjson");
